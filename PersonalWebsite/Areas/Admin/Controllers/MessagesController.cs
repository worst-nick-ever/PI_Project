...
namespace PersonalWebsite.Areas.Admin.Controllers
{
    public class MessagesController : AdminController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SenderEmail,About,Text")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SenderEmail,About,Text")] Message message)
        {
            if (ModelState.IsValid)
            {
